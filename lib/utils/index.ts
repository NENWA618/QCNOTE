...
export { truncateText, escapeHtml, getTextSummary, fuzzySearch, copyToClipboard } from './text';
...
export { generateId, getWordFrequency, sortNotes, getColorPalette } from './data';
