 ...
 * - 自动恢复上一个焦点元素
 */
export function useFocusTrap(ref: React.RefObject<HTMLDivElement>, onClose?: () => void) {
 ...
 * 宣布消息给屏幕阅读器
 */
export function announceToScreenReader(message: string, type: 'polite' | 'assertive' = 'polite') {
