 ...
 * Original file: /gh/fghrsh/live2d_demo@master/assets/live2d.js
 *
...
!(function (t) {
  ...
  function (t, e, i) {
    ...
    ((r.prototype.getModelMatrix = function () {
      ...
      (o.prototype.updateParamExe = function (t, e, i, r) {
        for (var n = this.paramList.length - 1; n >= 0; --n) {
          ...
          s.type == o.TYPE_ADD
            ? t.addToParamFloat(s.id, s.value, i)
            : s.type == o.TYPE_MULT
              ? t.multParamFloat(s.id, s.value, i)
              : s.type == o.TYPE_SET && t.setParamFloat(s.id, s.value, i);
        }
      }),
      ...
      (s.prototype.updateParam = function (t) {
        ...
        switch (this.eyeState) {
          case g.STATE_CLOSING:
            ((r = (i - this.stateStartTime) / this.closingMotionMsec) >= 1 &&
              ((r = 1), (this.eyeState = g.STATE_CLOSED), (this.stateStartTime = i)),
              (e = 1 - r));
            break;
          case g.STATE_CLOSED:
            ((r = (i - this.stateStartTime) / this.closedMotionMsec) >= 1 &&
              ((this.eyeState = g.STATE_OPENING), (this.stateStartTime = i)),
              (e = 0));
            break;
          case g.STATE_OPENING:
            ((r = (i - this.stateStartTime) / this.openingMotionMsec) >= 1 &&
              ((r = 1),
          ...
          case g.STATE_INTERVAL:
            (this.nextBlinkTime < i &&
              ((this.eyeState = g.STATE_CLOSING), (this.stateStartTime = i)),
              (e = 1));
            break;
          case g.STATE_FIRST:
          default:
    ...
    ((g.STATE_FIRST = 'STATE_FIRST'),
      ...
      (l.load = function (t) {
        for (
          var e = new l(),
            i = c.getPlatformManager().jsonParseFromBytes(t).physics_hair,
            r = i.length,
            o = 0;
          o < r;
          o++
      ...
      ($.load = function (t) {
        for (
          var e = new $(),
            i = c.getPlatformManager().jsonParseFromBytes(t).parts_visible,
            r = i.length,
            o = 0;
          o < r;
          o++
        ...
        if (0 != this.lastTimeSec) {
          ...
          if (!(Math.abs(o) <= this.EPSILON && Math.abs(n) <= this.EPSILON)) {
            ...
            ((l < -r || l > r) && ((a *= r / l), (h *= r / l), (l = r)),
              (this.faceVX += a),
              (this.faceVY += h));
            var $ = 0.5 * (Math.sqrt(r * r + 16 * r * s - 8 * r * s) - r),
      ...
      (f.prototype.adjustScale = function (t, e, i) {
        ...
        r < this.min
          ...
          : r > this.max && this.tr[0] > 0 && (i = this.max / this.tr[0]);
  ...
  function (t, e, i) {
    ...
    function o(t) {
      var e = L.width,
        i = L.height;
      M = new d.L2DTargetPoint();
      var r = i / e,
        o = y.default.VIEW_LOGICAL_LEFT,
        s = y.default.VIEW_LOGICAL_RIGHT,
        _ = -r,
        a = r;
      if (
        ((window.Live2D.captureFrame = !1),
        (E = new d.L2DViewMatrix()).setScreenRect(o, s, _, a),
        E.setMaxScreenRect(
          y.default.VIEW_LOGICAL_MAX_LEFT,
          y.default.VIEW_LOGICAL_MAX_RIGHT,
          y.default.VIEW_LOGICAL_MAX_BOTTOM,
          y.default.VIEW_LOGICAL_MAX_TOP,
        ),
        E.setMaxScale(y.default.VIEW_MAX_SCALE),
        E.setMinScale(y.default.VIEW_MIN_SCALE),
        (A = new d.L2DMatrix44()).multScale(1, e / i),
        (I = new d.L2DMatrix44()).multTranslate(-e / 2, -i / 2),
        I.multScale(2 / e, -2 / e),
        (v = (function () {
          for (
            var t = ['webgl', 'experimental-webgl', 'webkit-3d', 'moz-webgl'], e = 0;
            e < t.length;
            e++
          )
            try {
              var i = L.getContext(t[e], { premultipliedAlpha: !0 });
              if (i) return i;
            } catch (t) {}
          return null;
        })()),
      ...
      (window.Live2D.setGL(v),
        v.clearColor(0, 0, 0, 0),
        (function (t) {
          ((P.reloadFlg = !0), P.count++, P.changeModel(v, t));
        })(t),
        n());
    }
    function n() {
      S ||
        ...
        (function t() {
          !(function () {
            (m.default.reset(),
              m.default.loadIdentity(),
              M.update(),
              P.setDrag(M.getX(), M.getY()),
              v.clear(v.COLOR_BUFFER_BIT),
              m.default.multMatrix(A.getArray()),
              m.default.multMatrix(E.getArray()),
              m.default.push());
            for (var t = 0; t < P.numModels(); t++) {
              var e = P.getModel(t);
              if (null == e) return;
              e.initialized && !e.updating && (e.update(), e.draw(v));
            }
            m.default.pop();
          })();
          var e =
    ...
    function l(t) {
      if ('mousewheel' == t.type);
        ...
        ('1' === sessionStorage.getItem('Sleepy') && sessionStorage.setItem('Sleepy', '0'), _(t));
      } else if ('mouseup' == t.type) {
        if ('button' in t && 0 != t.button) return;
      } else if ('mouseout' == t.type) {
        (y.default.DEBUG_LOG && console.log('Mouse out Window.'), a());
        var e = sessionStorage.getItem('SleepyTimer');
        (window.clearTimeout(e),
          (e = window.setTimeout(h, 5e4)),
    ...
    function u(t) {
      var e = I.transformX(t);
      return E.invertTransformX(e);
    }
    function p(t) {
      var e = I.transformY(t);
      return E.invertTransformY(e);
    }
    function f(t) {
      return I.transformX(t);
    }
    function c(t) {
      return I.transformY(t);
    }
    i(6);
    var d = i(0),
      g = r(i(8)),
      ...
      m = r(i(3)),
      T = i(2),
      P = (window.navigator.platform.toLowerCase(), new g.default()),
      S = !1,
      v = null,
      L = null,
      M = null,
    ...
    window.loadlive2d = function (t, e, i) {
      ((x = void 0 === i ? 0.5 : i),
        (function (t) {
          (L = document.getElementById(t)).addEventListener &&
  ...
  function (t, e, i) {
    ...
    (function (t) {
      !(function () {
        ...
        function i(t) {
          if (!Lt) {
            ((this.clipContextList = new Array()),
              ...
              st.glContext.length > st.frameBuffers.length &&
        ...
        function l(t) {
          Lt || et.prototype.constructor.call(this, t);
        }
        function $(t) {
          Lt || et.prototype.constructor.call(this, t);
        }
        ...
        function V() {
          Lt ||
            ...
            (this.gl = null),
            null == V._$NT &&
              ((V._$NT = V._$9r(256)), (V._$vS = V._$9r(256)), (V._$no = V._$vb(256))));
        }
        function X() {
          Lt || (A.prototype.constructor.call(this), (this._$GS = null), (this._$Y0 = null));
        }
        function z(t) {
        ...
        function W() {
          Lt || ((this._$NL = null), (this._$3S = null), (this._$aS = null), W._$42++);
        }
        function j() {
          Lt || (e.prototype.constructor.call(this), (this._$zo = new V()));
        }
        function q() {
          Lt ||
            (s.prototype.constructor.call(this),
        ...
        ((e._$0s = 1),
            ...
            try {
              ...
              if (r >= U._$s7) {
                var l = o._$9T(),
                  $ = o._$9T();
                if (-30584 != l || -30584 != $)
                  throw ((t._$NP |= e._$0s), new at('_$gi _$C _$li , _$0 _$6 _$Ui.'));
              }
              t._$KS(h);
              ...
              if (1 == t.length) {
                ...
                for (u = 0; u < t.length; u++) {
                  ...
                  if (o == u) s.setPartsOpacity(h, n);
                    ...
                    var p,
                      f = s.getPartsOpacity(h);
                    ((1 - (p = n < 0.5 ? (-0.5 * n) / 0.5 + 1 : (0.5 * (1 - n)) / 0.5)) * (1 - n) >
                      0.15 && (p = 1 - 0.15 / (1 - n)),
                      f > p && (f = p),
                      s.setPartsOpacity(h, f));
                  }
                }
              }
            else
            ...
            if (i > 0) {
              ...
              ((s[0] = 0),
                ...
                e.gl.bindFramebuffer(
                  e.gl.FRAMEBUFFER,
                  st.frameBuffers[this.curFrameNo].framebuffer,
                ),
          ...
          (i.prototype.calcClippedDrawTotalBounds = function (t, e) {
            for (
              ...
              if (u._$yo()) {
                for (
                  var p = u.getTransformedPoints(), f = p.length, c = [], d = [], g = 0, y = B._$i2;
                  y < f;
                  y += B._$No
                )
                  ((c[g] = p[y]), (d[g] = p[y + 1]), g++);
          ...
          (s._$JT = function (t, e, i) {
            ...
            var h = r * r;
            return (
              (1 - 3 * a + 3 * _ - 0) * (r * h) + (3 * a - 6 * _ + 0) * h + (3 * _ - 0) * r + 0
            );
          }),
          ...
          (_.start = function (t) {
            var e = _._$fT[t];
            (null == e && (((e = new a())._$r = t), (_._$fT[t] = e)),
              (e._$0S = I.getSystemTimeMSec()));
          }),
          (_.dump = function (t) {
            var e = _._$fT[t];
            if (null != e) {
              var i = I.getSystemTimeMSec() - e._$0S;
          ...
          (p.Src = function () {}),
          (p.Src.SRC_TO_X = 'SRC_TO_X'),
          (p.Src.SRC_TO_Y = 'SRC_TO_Y'),
          (p.Src.SRC_TO_G_ANGLE = 'SRC_TO_G_ANGLE'),
          (p.Target = function () {}),
          (p.Target.TARGET_FROM_ANGLE = 'TARGET_FROM_ANGLE'),
          ...
          (T.prototype._$F0 = function (t) {
            ((this._$fL = t._$_T()),
              ...
              (this._$z0 = t._$_T()),
              (this._$qT = t._$_T()),
              t.getFormatVersion() >= U.LIVE2D_FORMAT_VERSION_V2_10_SDK2 &&
                ((this.reflectX = t._$po()), (this.reflectY = t._$po())));
          }),
          (T.prototype._$e = function () {}));
        var Mt = function () {};
        ((Mt._$ni = function (t, e, i, r, o, n, s, _, a) {
          var h = s * n - _ * o;
          if (0 == h) return null;
          var l,
            $ = ((t - i) * n - (e - r) * o) / h;
          return (
            (l = 0 != o ? (t - i - $ * s) / o : (e - r - $ * _) / n),
            isNaN(l) &&
              ((l = (t - i - $ * s) / o),
              isNaN(l) && (l = (e - r - $ * _) / n),
              isNaN(l) &&
          ...
          (S._$Z2 = function (t, e, i, r) {
            ...
            if (1 == o) return ((_ = r[n[0]]) + ((a = r[n[1]]) - _) * (m = s[0])) | 0;
            if (2 == o) {
              var _ = r[n[0]],
                a = r[n[1]],
                h = r[n[2]],
              ...
              return (
                ((S =
                  ((_ =
                    ...
                    0) +
                    ((a =
                      ((p = (A + (I - A) * m) | 0) + ((f = (w + (x - w) * m) | 0) - p) * T) | 0) -
                      _) *
                      (P = s[2])) |
                  0) +
                  ((((h =
                    ((c = (O + (D - O) * m) | 0) + ((d = (R + (b - R) * m) | 0) - c) * T) | 0) +
                    ((l =
                      ((g = (F + (C - F) * m) | 0) + ((y = (N + (B - N) * m) | 0) - g) * T) | 0) -
                      h) *
                      P) |
                    0) -
                    S) *
          ...
          (S._$Vr = function (t, e, i, r, o, n, s, _) {
            ...
            if (a <= 0) {
              var p = o[h[0]];
              if (2 == _ && 0 == s) I._$jT(p, 0, n, 0, $);
              else for (var f = 0; f < $; ) ((n[u] = p[f++]), (n[u + 1] = p[f++]), (u += _));
            } else if (1 == a) {
              p = o[h[0]];
              var c = o[h[1]],
                d = 1 - (m = l[0]);
              ...
              var g = o[h[2]],
                ...
                v = R * m;
              for (f = 0; f < $; )
                ((n[u] = T * p[f] + P * c[f] + S * g[f] + v * y[f]),
                  ++f,
                  (n[u + 1] = T * p[f] + P * c[f] + S * g[f] + v * y[f]),
                  ++f,
                  (u += _));
            } else if (3 == a) {
              var L = o[h[0]],
              ...
              for (f = 0; f < $; ) {
                var Rt = 0,
                  ...
                  Ft = f + 1;
                for (Dt = 0; Dt < Mt; Dt++)
                  ((Rt += Et[Dt] * Ot[Dt][f]), (bt += Et[Dt] * Ot[Dt][Ft]));
          ...
          (O.prototype._$Q2 = function (t, e) {
            for (var i, r, o = this._$Ob.length, n = t._$v2(), s = 0, _ = 0; _ < o; _++) {
              var a = this._$Ob[_];
              if (
                ((i = a.getParamIndex(n)) == w._$ds &&
                  ((i = t.getParamIndex(a.getParamID())), a._$Pb(i, n)),
                i < 0)
              )
          ...
          (b.prototype.transform = function (t, e, i) {
            ...
            switch (this._$hi) {
              ...
              case b.STATE_IDENTITY:
                return void ((t == e && h == l) || I._$jT(t, h, e, l, 2 * i));
            }
          }),
          ...
          (b.prototype._$RT = function (t) {
            ...
            var e = t[0],
              ...
              s = e * o - i * r;
            0 == n
              ? st._$so && console.log('affine._$RT() / rt==0')
              : ((t[0] = n),
                (t[1] = s / n),
                (t[2] = (r * o + e * i) / s),
                (t[3] = Math.atan2(r, e)));
                ...
                if ('#' != n)
                  if ('$' != n) {
                    if (('a' <= n && n <= 'z') || ('A' <= n && n <= 'Z') || '_' == n) {
                      ...
                      if (_ >= 0) {
                        var a = new N();
                        (x.startsWith(t, s, F._$cs)
                          ? ((a._$RP = N._$hs), (a._$4P = new String(t, s, _ - s)))
                          : x.startsWith(t, s, F._$ar)
                            ? ((a._$4P = new String(t, s + 7, _ - s - 7)),
                              x.startsWith(t, s + 7, 'ANCHOR_X')
                                ? (a._$RP = N._$xs)
                                : x.startsWith(t, s + 7, 'ANCHOR_Y')
                                  ? (a._$RP = N._$us)
                                  : x.startsWith(t, s + 7, 'SCALE_X')
                                    ? (a._$RP = N._$qs)
                                    : x.startsWith(t, s + 7, 'SCALE_Y')
                                      ? (a._$RP = N._$Ys)
                                      : x.startsWith(t, s + 7, 'X')
                                        ? (a._$RP = N._$ws)
                                        : x.startsWith(t, s + 7, 'Y') && (a._$RP = N._$Ns))
                            : ((a._$RP = N._$Fr), (a._$4P = new String(t, s, _ - s))),
                          e.motions.push(a));
                        var h = 0;
                        for (
                          F._$D2.clear(), o = _ + 1;
                        ...
                        ((a._$I0 = F._$D2._$BL()), h > e._$yT && (e._$yT = h));
                      }
                    }
                  } else {
                    ...
                    if (_ >= 0)
                      for (
                        ...
                        if (',' != n && ' ' != n && '\t' != n) {
                          l = x._$LS(t, r, o, i);
                          (i[0] > 0 && u && 5 < l && l < 121 && (e._$D0 = l), (o = i[0]));
                        }
                    for (; o < r && '\n' != t[o] && '\r' != t[o]; ++o);
                  }
                else for (; o < r && '\n' != t[o] && '\r' != t[o]; ++o);
          ...
          (F.prototype.updateParamExe = function (t, e, i, r) {
            for (
              var o = ((e - r._$z2) * this._$D0) / 1e3, n = 0 | o, s = o - n, _ = 0;
            ...
            n >= this._$yT &&
              (this._$E ? ((r._$z2 = e), this.loopFadeIn && (r._$bs = e)) : (r._$9L = !0));
          }),
          ...
          (C.prototype.add = function (t) {
            if (this._$P.length <= this.size) {
              ...
              (I._$jT(this._$P, 0, e, 0, this.size), (this._$P = e));
            }
          ...
          (G.prototype.update = function () {
            ...
            for (var t = this._$_2.length, e = 0; e < t; e++)
              this._$_2[e] != this._$vr[e] &&
                ((this._$Js[e] = G._$ZS), (this._$vr[e] = this._$_2[e]));
          ...
          (G.prototype._$UT = function (t, e) {
            ...
            return (I._$jT(t, 0, i, 0, t.length), i);
          }),
            ...
            switch (this._$_L) {
              case STATE_CLOSING:
                ((r = (i - this._$bb) / this._$Dr) >= 1 &&
                  ((r = 1), (this._$_L = Et.STATE_CLOSED), (this._$bb = i)),
                  (e = 1 - r));
                break;
              case STATE_CLOSED:
                ((r = (i - this._$bb) / this._$Cb) >= 1 &&
                  ((this._$_L = Et.STATE_OPENING), (this._$bb = i)),
                  (e = 0));
                break;
              case STATE_OPENING:
                ((r = (i - this._$bb) / this._$mr) >= 1 &&
                  ((r = 1), (this._$_L = Et.STATE_INTERVAL), (this._$12 = this._$T2())),
                  (e = r));
                break;
              case STATE_INTERVAL:
        ...
        ((Et.STATE_FIRST = 'STATE_FIRST'),
          ...
          (V._$cr = function (t, e) {
            return (
              null == t || t._$yL() < e.length
                ? ((t = V._$9r(2 * e.length)).put(e), t._$oT(0))
          ...
          (V._$mb = function (t, e) {
            return (
              null == t || t._$yL() < e.length
                ? ((t = V._$vb(2 * e.length)).put(e), t._$oT(0))
                : (t.clear(), t.put(e), t._$oT(0)),
              t
            );
          }),
          ...
          (V.prototype._$nS = function (t) {
            var e = Math.max(2 * this._$sb.length, t + 1 + 10),
              i = new Int32Array(e);
            (I._$jT(this._$sb, 0, i, 0, this._$sb.length), (this._$sb = i));
            var r = new Array();
          ...
          (X.prototype._$2b = function (t, e) {
            ...
            if ((i._$hS(!0), this._$32())) {
              ...
              if ((i._$8r == A._$ur && (i._$8r = t.getBaseDataIndex(r)), i._$8r < 0))
                (st._$so && _._$li('_$L _$0P _$G :: %s', r), i._$hS(!1));
              else {
          ...
          (X.prototype._$nb = function (t, e, i, r, o, n, s) {
            ...
            for (
              var _,
                ...
                $ = Math.sin(Pt._$bS * l._$qT),
                u = Math.cos(Pt._$bS * l._$qT),
                p = h.getTotalScale(),
                f = l.reflectX ? -1 : 1,
                c = l.reflectY ? -1 : 1,
                d = u * p * f,
                ...
                if ('#' != n)
                  if ('$' != n) {
                    if ((97 <= s && s <= 122) || (65 <= s && s <= 90) || '_' == n) {
                      ...
                      if (a >= 0) {
                        var h = new N();
                        (x.startsWith(t, _, q._$cs)
                          ? ((h._$RP = N._$hs), (h._$4P = x.createString(t, _, a - _)))
                          : x.startsWith(t, _, q._$ar)
                            ? ((h._$4P = x.createString(t, _ + 7, a - _ - 7)),
                              x.startsWith(t, _ + 7, 'ANCHOR_X')
                                ? (h._$RP = N._$xs)
                                : x.startsWith(t, _ + 7, 'ANCHOR_Y')
                                  ? (h._$RP = N._$us)
                                  : x.startsWith(t, _ + 7, 'SCALE_X')
                                    ? (h._$RP = N._$qs)
                                    : x.startsWith(t, _ + 7, 'SCALE_Y')
                                      ? (h._$RP = N._$Ys)
                                      : x.startsWith(t, _ + 7, 'X')
                                        ? (h._$RP = N._$ws)
                                        : x.startsWith(t, _ + 7, 'Y') && (h._$RP = N._$Ns))
                            : ((h._$RP = N._$Fr), (h._$4P = x.createString(t, _, a - _))),
                          e.motions.push(h));
                        var l = 0,
                          $ = [];
                    ...
                    if (a >= 0)
                      for (
                        ...
                        if (',' != n && ' ' != n && '\t' != n) {
                          u = x._$LS(t, r, o, i);
                          (i[0] > 0 && f && 5 < u && u < 121 && (e._$D0 = u), (o = i[0]));
                        }
                    for (; o < r && '\n' != J(t, o) && '\r' != J(t, o); ++o);
                  }
                else for (; o < r && '\n' != J(t, o) && '\r' != J(t, o); ++o);
            ...
            for (
              ...
              if (a._$RP == N._$hs) {
                ...
                var u = t.getParamIndex(l),
                  ...
                  y =
                    c +
                    (((d < g && g - d > f) || (d > g && d - g > f) ? d : d + (g - d) * s) - c) * i;
                t.setParamFloat(l, y);
              }
            }
            (n >= this._$yT &&
          ...
          (Q.transformPoints_sdk2 = function (e, i, r, o, n, s, _, a) {
            for (
              ...
              var P, S, v, L;
              if (
                ((v = e[T]), (S = (L = e[T + 1]) * a), (P = v * _) < 0 || S < 0 || _ <= P || a <= S)
              ) {
                var M = _ + 1;
                if (!m) {
                  ((m = !0),
                  ...
                  ((p -= 0.5 * ((c = 0.5 * (E + I)) + (g = 0.5 * (E - I)))),
                    (f -= 0.5 * ((d = 0.5 * (A + w)) + (y = 0.5 * (A - w)))));
                }
                if (-2 < v && v < 3 && -2 < L && L < 3)
                  if (v <= 0)
                    if (L <= 0) {
                      var x = s[2 * (0 + 0 * M)],
                        ...
                        C = p - 2 * c - 2 * g,
                        N = f - 2 * d - 2 * y;
                      (B = 0.5 * (v - -2)) + (U = 0.5 * (L - -2)) <= 1
                        ? ((i[T] = C + (b - C) * B + (D - C) * U),
                          (i[T + 1] = N + (F - N) * B + (R - N) * U))
                        : ((i[T] = x + (D - x) * (1 - B) + (b - x) * (1 - U)),
                          (i[T + 1] = O + (R - O) * (1 - B) + (F - O) * (1 - U)));
                    } else if (L >= 1) {
                      ((b = s[2 * (0 + a * M)]),
                        (F = s[2 * (0 + a * M) + 1]),
                        (C = p - 2 * c + 1 * g),
          ...
          (rt.prototype.drawElements = function (t, e, i, r, o, n, s, a) {
            try {
              ...
              for (
                ...
                (Mt._$ni(F, C, O, D, R - O, b - D, -(b - D), R - O, y),
                  Mt._$ni(w, x, M, E, A - M, I - E, -(I - E), A - M, m));
                var z = (m[0] - y[0]) / y[1],
                  H = Math.min(O, R, F),
                  W = Math.max(O, R, F),
                  j = Math.min(D, b, C),
                ...
                if (
                  ...
                  if (((tt.gl_cacheImage = tt.gl_cacheImage || {}), !tt.gl_cacheImage[P])) {
                    ...
                    (it.translate(-J, -Q),
                      rt.clip(it, g, n, Y, O, D, R, b, F, C, M, E, A, I, w, x),
                      it.drawImage(t, 0, 0),
                      (tt.gl_cacheImage[P] = { cacheCanvas: et, cacheContext: it }));
                  }
                  u.drawImage(tt.gl_cacheImage[P].cacheCanvas, J, Q);
                } else
                  (st.IGNORE_CLIP || rt.clip(u, g, n, Y, O, D, R, b, F, C, M, E, A, I, w, x),
          ...
          (rt.clip = function (t, e, i, r, o, n, s, _, a, h, l, $, u, p, f, c) {
            i > 0.02
              ? rt.expandClip(t, e, i, r, l, $, u, p, f, c)
              : rt.clipWithTransform(t, null, o, n, s, _, a, h);
          }),
          (rt.expandClip = function (t, e, i, r, o, n, s, _, a, h) {
            ...
            return (
              null != e._$P2(N) &&
              (rt.clipWithTransform(t, N, M, E, A, I, w, x, O, D, F, C, R, b), !0)
            );
          }),
          ...
          (st.initProfile = function () {
            vt.isIOS()
              ? st.setupProfile(st.PROFILE_IOS_DEFAULT)
              : vt.isAndroid()
                ? st.setupProfile(st.PROFILE_ANDROID)
                : st.setupProfile(st.PROFILE_DESKTOP);
          }),
          ...
          (_t._$r2 = function (t) {
            return t < 0 ? 0 : t > 1 ? 1 : 0.5 - 0.5 * Math.cos(t * Pt.PI_F);
          }),
          (at._$fr = -1),
          ...
          (ht.prototype._$2b = function (t, e) {
            try {
              ...
              if (!i && (H.prototype._$2b.call(this, t), this._$32())) {
                ...
                if ((r._$8r == H._$ur && (r._$8r = t.getBaseDataIndex(o)), r._$8r < 0))
          ...
          (gt._$cr = function (t, e) {
            return (
              null == t || t._$yL() < e.length
                ? ((t = gt._$9r(2 * e.length)).put(e), t._$oT(0))
                : (t.clear(), t.put(e), t._$oT(0)),
              t
            );
          }),
          (gt._$mb = function (t, e) {
            return (
              null == t || t._$yL() < e.length
                ? ((t = gt._$vb(2 * e.length)).put(e), t._$oT(0))
                : (t.clear(), t.put(e), t._$oT(0)),
              t
            );
          }),
          ...
          (gt.prototype._$Uo = function (t, e, i, r, o, n, s, _) {
            if (!(n < 0.01 && null == this.clipBufPre_clipContextMask)) {
              var a = (n > 0.9 && st.EXPAND_W, this.gl);
              ...
              if (null != this.clipBufPre_clipContextMask) {
                ...
                a.uniform4f(this.u_channelFlag, y.r, y.g, y.b, y.a);
                ...
                ((g = this.getClipBufPre_clipContextDraw().layoutChannelNo),
                  (y = this.getChannelFlagAsColor(g)));
                (a.uniform4f(this.u_channelFlag_Loc_Off, y.r, y.g, y.b, y.a),
                  a.uniform4f(this.u_baseColor_Loc_Off, p, f, c, d));
              } else
                (a.useProgram(this.shaderProgram),
                  (this._$vS = yt(a, this._$vS, r)),
                  (this._$no = mt(a, this._$no, i)),
                  ...
                  a.uniform4f(this.u_baseColor_Loc, p, f, c, d),
          ...
          (gt.prototype.compileShader = function (t, e) {
            ...
            if (
              (i.shaderSource(o, r), i.compileShader(o), !i.getShaderParameter(o, i.COMPILE_STATUS))
            ) {
          ...
          (gt.prototype.createFramebuffer = function () {
            ...
            return (
              ...
              { framebuffer: i, renderbuffer: r, texture: st.fTexture[this.glno] }
            );
          }),
          (Tt.prototype._$fP = function () {
            var t,
              ...
              i,
              r = this._$ST();
            if (!(128 & r)) return 255 & r;
            if (!(128 & (t = this._$ST()))) return ((127 & r) << 7) | (127 & t);
            if (!(128 & (e = this._$ST()))) return ((127 & r) << 14) | ((127 & t) << 7) | (255 & e);
            if (!(128 & (i = this._$ST())))
        ...
        ((Tt.prototype._$bT = function () {
          ...
          (vt.setup = function () {
            ...
            var e,
              i = vt.USER_AGENT,
              r = (vt.SYSTEM_INFO = { userAgent: i });
            if ((e = i.indexOf('iPhone OS ')) >= 0)
              ((r.os = 'iPhone'), (r._isIPhone = !0), (r.version = t(i, e + 10)));
            else if ((e = i.indexOf('iPad')) >= 0) {
              if ((e = i.indexOf('CPU OS')) < 0)
                return void _._$li(' err : ' + i + ' @UtHtml5.setup()');
              ((r.os = 'iPad'), (r._isIPad = !0), (r.version = t(i, e + 7)));
            } else
              (e = i.indexOf('Android')) >= 0
                ? ((r.os = 'Android'), (r._isAndroid = !0), (r.version = t(i, e + 8)))
                : ((r.os = '-'), (r.version = -1));
          }),
          (window.UtSystem = I),
          (window.UtDebug = _),
  ...
  function (t, e, i) {
    ...
    ((o.prototype.createModel = function () {
      ...
      (o.prototype.maxScaleEvent = function () {
        ...
        for (var t = 0; t < this.models.length; t++)
          this.models[t].startRandomMotion(
            a.default.MOTION_GROUP_PINCH_IN,
            a.default.PRIORITY_NORMAL,
          );
      }),
      (o.prototype.minScaleEvent = function () {
        ...
        for (var t = 0; t < this.models.length; t++)
          this.models[t].startRandomMotion(
            a.default.MOTION_GROUP_PINCH_OUT,
            a.default.PRIORITY_NORMAL,
          );
      }),
      (o.prototype.tapEvent = function (t, e) {
        ...
        for (var i = 0; i < this.models.length; i++)
          this.models[i].hitTest(a.default.HIT_AREA_HEAD, t, e)
            ? (a.default.DEBUG_LOG && console.log('Tap face.'),
              this.models[i].setRandomExpression())
            : this.models[i].hitTest(a.default.HIT_AREA_BODY, t, e)
              ? (a.default.DEBUG_LOG && console.log('Tap body. models[' + i + ']'),
                this.models[i].startRandomMotion(
                  a.default.MOTION_GROUP_TAP_BODY,
                  a.default.PRIORITY_NORMAL,
                ))
              : this.models[i].hitTestCustom('head', t, e)
                ? (a.default.DEBUG_LOG && console.log('Tap face.'),
                  this.models[i].startRandomMotion(
                    a.default.MOTION_GROUP_FLICK_HEAD,
                    a.default.PRIORITY_NORMAL,
                  ))
    ...
    ((r.prototype.loadBytes = function (t, e) {
      if (void 0 === n[t]) {
        ...
        (i.open('GET', t, !0),
          ...
          (i.onload = function () {
            if (200 === i.status) ((n[t] = i.response), e(i.response));
            else console.error('Failed to load (' + i.status + ') : ' + t);
          }),
          i.send(null));
      } else e(n[t]);
    }),
          ...
          r.loadModelData(t, function (t) {
            for (var e = 0; e < r.modelSetting.getTextureNum(); e++) {
              if (/^https?:\/\/|^\/\//i.test(r.modelSetting.getTextureFile(e)))
                var o = r.modelSetting.getTextureFile(e);
              else o = r.modelHomeDir + r.modelSetting.getTextureFile(e);
              r.loadTexture(e, o, function () {
                if (r.isTexLoaded) {
                  ...
                  if (null != r.modelSetting.getHitAreasCustom()) {
                    ...
                    (null != s.head_x && (_.default.hit_areas_custom_head_x = s.head_x),
                      null != s.head_y && (_.default.hit_areas_custom_head_y = s.head_y),
                      null != s.body_x && (_.default.hit_areas_custom_body_x = s.body_x),
                      null != s.body_y && (_.default.hit_areas_custom_body_y = s.body_y));
                  }
        ...
        if (null != this.live2DModel) {
          ...
          (this.mainMotionManager.isFinished() &&
            ('1' === sessionStorage.getItem('Sleepy')
              ? this.startRandomMotion(_.default.MOTION_GROUP_SLEEPY, _.default.PRIORITY_SLEEPY)
              : this.startRandomMotion(_.default.MOTION_GROUP_IDLE, _.default.PRIORITY_IDLE)),
      ...
      (o.prototype.hitTestCustom = function (t, e, i) {
        return 'head' == t
          ? this.hitTestSimpleCustom(
              _.default.hit_areas_custom_head_x,
              _.default.hit_areas_custom_head_y,
              e,
              i,
            )
          : 'body' == t &&
              this.hitTestSimpleCustom(
                _.default.hit_areas_custom_body_x,
                _.default.hit_areas_custom_body_y,
                e,
                i,
              );
      }));
...
//# sourceMappingURL=/sm/076347b9271fc19429bc186a8590b48acc0bfe0f9d9fa2ee8224e24ea3b89f6a.map
