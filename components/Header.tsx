  ...
  return (
    <header className="nav-shell">
      <nav className="relative max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-4 px-4 sm:px-6 lg:px-8 py-4">
        <Link
          href="/"
          className="flex items-center gap-3 text-2xl font-bold text-primary-dark no-underline hover:text-accent-pink transition-all hover:scale-105"
        >
          <Image
        ...
        <div className="flex items-center gap-2">
          ...
          {session && (
            <div className="relative user-menu">
              <button
                ...
                className="w-9 h-9 bg-gradient-to-br from-accent-pink to-accent-purple rounded-full flex items-center justify-center text-white text-sm font-semibold hover:scale-110 transition-transform"
              >
          ...
          <button
            className="md:hidden p-2 text-primary-dark hover:bg-primary-light rounded-2xl transition-colors dark:text-dark-text dark:hover:bg-dark-surface-light"
