          ...
          <div className="p-6 space-y-4" style={{ minHeight: '520px' }}>
            <div className="space-y-3">
              {messages.map((message, index) => (
                ...
                >
                  <div
                    className={`max-w-[80%] whitespace-pre-wrap rounded-3xl p-4 text-sm leading-6 ${
                      message.sender === 'user'
                  ...
                  <div className="flex flex-wrap gap-3">
                    {categories.map((category) => (
                      <button
                        ...
                        type="button"
                        onClick={() =>
                          selectCategory(category.id || category.categoryId, category.name)
                        }
