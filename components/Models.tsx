    ...
    try {
      ...
      if (sessionUserId) {
        const ownedResponse = await axios.get(
          withApiBaseUrl(`/api/ugc/models/owned/${sessionUserId}`),
        );
        const ownedModels: Live2DModel[] = ownedResponse.data.success
          ? ownedResponse.data.models
          : [];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-light via-primary-medium to-purple-200 text-primary-dark dark:bg-dark-bg p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold mb-8 text-primary-dark dark:text-dark-text">
          Live2D模型管理
        </h1>
        ...
        {sessionUserId === userId && (
          <div className="space-y-6">
            ...
            <div className="card dark:bg-dark-surface dark:border-dark-border">
              <h2 className="text-2xl font-bold text-primary-dark dark:text-dark-text mb-6">
                我的Live2D模型
              </h2>
            ...
            <div className="card dark:bg-dark-surface dark:border-dark-border">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                {marketModels.map((model) => (
                  <div
                    key={model.id}
                    className="border border-primary-medium dark:border-dark-border rounded-lg p-4 hover:shadow-medium transition"
                  >
                    <div className="text-center mb-4">
                      <div className="text-4xl mb-2">🎭</div>
                      <h3 className="font-bold text-primary-dark dark:text-dark-text">
                        {model.name}
                      </h3>
            ...
            <div className="card dark:bg-dark-surface dark:border-dark-border">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-primary-dark dark:text-dark-text mb-2">
                    设置价格 (积分)
                  </label>
                  <input
                    type="number"
