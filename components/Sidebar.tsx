...
const Sidebar: React.FC<Props> = ({
  ...
  return (
    <aside className={`w-full md:w-72 flex-shrink-0 transition-all ${isOpen ? 'block' : 'hidden md:block'}`}>
          ...
          <div className="bg-gray-50 rounded-lg p-3">
            ...
            {filtersOpen && (
              <div className="mt-3 space-y-3">
                <div>
                  <label htmlFor="sidebar-sort" className="block text-xs font-medium text-gray-600 mb-1">
                    排序方式
                  </label>
                  <select
                    id="sidebar-sort"
                ...
                <div>
                  <label htmlFor="sidebar-search" className="block text-xs font-medium text-gray-600 mb-1">
                    搜索笔记
                  </label>
                  <input
                    id="sidebar-search"
