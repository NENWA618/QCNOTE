      ...
      <Layout footerLayout="minimal">
        ...
        <section id="features" className="mt-12 md:mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            <div className="card group border border-accent-purple/20 bg-white/95">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-primary-dark text-lg font-semibold group-hover:text-accent-pink transition-colors">
                  Markdown + KaTeX
                </h3>
              </div>
              <p className="text-text-light leading-relaxed">
                支持标准 Markdown、GitHub 风格扩展和数学公式，实时编辑与预览同步输出。
              </p>
            </div>
            ...
            <div className="card group border border-accent-purple/20 bg-white/95">
              ...
              <p className="text-text-light leading-relaxed">
                使用 <code>[[笔记标题]]</code> 创建双向链接，自动生成反向链接并构建笔记关联网。
              </p>
            </div>
            ...
            <div className="card group border border-accent-purple/20 bg-white/95">
              ...
              <p className="text-text-light leading-relaxed">
                结合 Lunr 全文搜索与向量语义匹配，支持标签、分类和日期筛选。
              </p>
            </div>
            ...
            <div className="card group border border-accent-purple/20 bg-white/95">
              ...
              <p className="text-text-light leading-relaxed">
                登录后可启用本地 AES-GCM 加密，对敏感字段按账号命名空间分区存储。
              </p>
            </div>
            ...
            <div className="card group border border-accent-purple/20 bg-white/95">
              ...
              <p className="text-text-light leading-relaxed">
                可选配置 WebDAV 或 OneDrive，同步内容到你授权的云端存储。
              </p>
            </div>
          ...
          <div className="card">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
              ...
              <div>
                ...
                <p className="text-text-light">
                  使用 Markdown 格式、LaTeX 公式、双链引用。内容自动保存到本地，并采用字段级 AES-GCM
                  加密存储，确保笔记主体在本地加密保存。
                </p>
              </div>
              <div>
