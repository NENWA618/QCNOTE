...
import { getProviders, signIn, getSession, type ClientSafeProvider } from 'next-auth/react';
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="登录 QCNOTE 访问你的笔记和个人主页。" />
      </Head>
      <Layout>
        <div className="min-h-[calc(100vh-14rem)] flex items-center justify-center px-4">
          <div className="max-w-md w-full space-y-8">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold text-primary-dark dark:text-white mb-2">
                欢迎回来
              </h2>
              <p className="text-text-light">登录您的账户以访问个人主页</p>
            </div>
            ...
            <div className="card p-8">
              ...
              <div className="mt-6 text-center">
                <p className="text-text-light text-sm">登录后即可访问个人主页</p>
              </div>
            </div>
