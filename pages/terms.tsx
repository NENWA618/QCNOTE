        ...
        <main className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="card">
            <p className="text-text-light leading-relaxed mb-4">
              欢迎使用
              QCNOTE。使用本应用即表示你接受以下使用条款。请在开始使用前仔细阅读并理解这些条款。
            </p>

            <h2 className="text-lg font-semibold text-primary-dark mt-4 mb-2">1. 服务描述</h2>
            <p className="text-text-light mb-4">
              QCNOTE
              是一款个人笔记管理工具，提供本地创建、编辑、导出、导入和搜索笔记的功能。应用支持
              Markdown、LaTeX、双链、版本历史和知识图谱等特性。笔记主体采用 QCNOTE DSL
              加密存储，并支持登录账号级隔离。
            </p>
            ...
            <p className="text-text-light mb-4">
              你对在 QCNOTE
              中生成、保存、导入或同步的内容负全部责任。你保证拥有所创建内容的合法权利，并遵守适用法律法规。
            </p>

            <h2 className="text-lg font-semibold text-primary-dark mt-4 mb-2">3. 数据责任</h2>
            <p className="text-text-light mb-4">
              QCNOTE 主要通过浏览器本地存储保存数据。你的笔记主体字段在本地采用 QCNOTE DSL
              加密存储，并按登录账号隔离。你应自行备份重要笔记内容，并妥善保管同步配置。对于因设备故障、浏览器问题或用户操作导致的数据丢失，我们不承担责任。
            </p>

            <h2 className="text-lg font-semibold text-primary-dark mt-4 mb-2">4. 同步服务</h2>
            <p className="text-text-light mb-4">
              当你启用 WebDAV 或 OneDrive
              同步时，相关数据将根据你的配置传输到第三方服务。第三方服务的隐私政策和安全措施由其提供商负责，QCNOTE
              仅提供同步功能，不对第三方服务的数据处理结果承担责任。
            </p>
            <p className="text-text-light mb-4">
              请注意，QCNOTE 的本地笔记主体字段在同步前已使用 DSL 加密保护，云同步仅在你授权后执行。
            </p>
            ...
            <p className="text-text-light mb-4">
              QCNOTE 的源代码遵循仓库内声明的 MIT
              许可证。你可以在遵守该许可证条款的前提下使用、修改和分发本项目。
            </p>
            <p className="text-text-light mb-4">
              应用中可能使用部分第三方开源素材，例如 Live2D 模型《koharu》，其授权许可可能与 MIT
              许可不同。使用或分发这些素材时，请遵守相应授权条款。
            </p>
