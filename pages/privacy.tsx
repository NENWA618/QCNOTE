        ...
        <main className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="card">
            <p className="text-text-light leading-relaxed mb-4">
              QCNOTE
              致力于保护你的隐私并提供安全的本地笔记体验。以下内容说明我们如何处理你的数据，以及你作为用户的权利。
            </p>

            <h2 className="text-lg font-semibold text-primary-dark mt-4 mb-2">1. 本地存储优先</h2>
            <p className="text-text-light mb-4">
              QCNOTE
              默认将笔记内容、标签、分类、设置和搜索索引存储在你的浏览器本地（IndexedDB）。笔记主体字段（如标题和内容）通过
              QCNOTE DSL 的字段级 AES-GCM
              加密存储在本地。每个登录账号的笔记数据也会按账号隔离，避免不同账号之间的数据混淆。
            </p>

            <h2 className="text-lg font-semibold text-primary-dark mt-4 mb-2">2. 可选同步</h2>
            <p className="text-text-light mb-4">
              如果你选择启用 WebDAV 或
              OneDrive，同步行为仅在你完成配置后才会发生。我们不会在未经你授权的情况下自动开启云同步。
            </p>
            <p className="text-text-light mb-4">
            ...
            <p className="text-text-light mb-4">
              需要强调的是，QCNOTE
              在本地对笔记主体采用加密存储后再进行同步，这意味着即便使用同步功能，核心笔记字段在本地仍受
              DSL 加密保护。
            </p>
