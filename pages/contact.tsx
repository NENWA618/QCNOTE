  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="联系 QCNOTE 团队。反馈建议、问题报告、合作洽谈等。我们期待听到你的声音！"
        />
      </Head>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="card text-center">
                ...
                <p className="text-text-light text-sm mt-4">📬 i24026878@student.newinti.edu.my</p>
              </div>

              <div className="card text-center">
                <h2 className="text-primary-dark mb-4 text-2xl font-bold">🐙 GitHub</h2>
                <p className="text-text-light mb-6">查看源代码、提交 Issue、贡献代码。</p>
                <a
                ...
                <p className="text-text-light text-sm mt-4">🔗 NENWA618/QCNOTE</p>
              </div>
            </div>
            ...
            <div className="card text-center">
              ...
              <p className="text-text-light text-sm mt-4">💳 TNG 转账</p>
            </div>
          </div>
        </section>
